...
def get_market_trends_task(product_name: str, agent: Agent):
    return Task(
        ...
        output_file="data/pazar_analizi_raporu.md",
        agent=agent
    )
...
def get_pricing_analysis_task(product_name: str, costs: dict[str, float], agent: Agent):
    ...
    return Task(
        ...
        output_file="data/fiyat_analizi_raporu.md",
        agent=agent
    )
...
def get_social_media_task(product_name: str, agent: Agent):
    return Task(
        ...
        output_file="data/sosyal_medya_raporu.md",
        agent=agent
    )
...
def get_support_task(product_name: str, agent: Agent):
    return Task(
        ...
        output_file="data/satis_sonrasi_destek_raporu.md",
        agent=agent
    )
